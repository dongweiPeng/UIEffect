	...
	SubShader
	{
		...
		CGPROGRAM
			...
			fixed4 frag(v2f IN) : SV_Target
			{
				...
				#elif CUTOFF
//				alpha = alpha - 1 + effectFactor * 1.01;
//				alpha = smoothstep(0.001, 0.2, alpha)*0.2 + step(0.2, alpha) * 0.8;
//				color.a *= alpha;

				color.a = step(0.001, color.a * alpha - 1 + effectFactor);
//				color.a = color.a * alpha - 1 + effectFactor;
//				color.a = smoothstep(0.001, 0.1, color.a)*0.1 + color.a - 0.1;
				#endif
